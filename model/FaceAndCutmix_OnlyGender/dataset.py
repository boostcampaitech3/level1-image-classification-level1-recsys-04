...
class BaseAugmentation:
    def __init__(self, resize=[380, 380], mean=(0.535, 0.491, 0.464), std=(0.237, 0.244, 0.251)):
...
class CustomAugmentation:
    def __init__(self, resize, mean, std, **args):
        self.transform = transforms.Compose([
            ...
            Normalize(mean=mean, std=std), # mean=(0.535, 0.491, 0.464), std=(0.237, 0.244, 0.251)
...
class MaskBaseDataset(Dataset):
    ...
    def __init__(self, data_dir, mean=(0.535, 0.491, 0.464), std=(0.237, 0.244, 0.251), val_ratio=0.2):
...
class CutMixDataset(MaskSplitByProfileDataset):
    def __init__(self, data_dir, mean=(0.535, 0.491, 0.464), std=(0.237, 0.244, 0.251), val_ratio=0.2):
        ...
        super().__init__(data_dir, mean, std, val_ratio)
        print (f"@ Dataset: CutMixDataset called with num_classes={self.num_classes}")
    ...
    def __getitem__(self, index):
        ...
        # 나이가 60대인 사람들 horizontalflip
        if age11_label in [6]:
            
            if self.printInfo:
                self.printInfo = False
                print ("@ Activate RandomHorizontalFlip on 60's")
        ...
        #if age11_label in [3,4,6]:
        #    image_transform = RandomHorizontalFlip().forward(image_transform)

        #return image_transform, age_albel
...
class TestDataset(Dataset):
    def __init__(self, img_paths, resize, mean=(0.527, 0.465, 0.435), std=(0.240, 0.242, 0.243)):
